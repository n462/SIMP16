perform_picrust <- function(destination, asvtax, asvpi) {
...
#asvtax <- read.csv("taxonomy.csv")  # Assuming you have a file named "taxonomy.csv" containing taxonomy data
#asvpi <- read.csv("asv_data.csv")    # Assuming you have a file named "asv_data.csv" containing ASV data

# Call the function
#perform_picrust(destination, asvtax, asvpi)
